...
if (isset($_POST['submit'])) {
    ...
    $sql_insert_post = "INSERT INTO vlink (vlink,vdate, text)
                        VALUES ('{$note}','{$post_date}','{$text}');";
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-offset-3 col-md-6">
                ...
                <div class="form-group">
                        <label for="exampleInputPassword1">Youtube Description</label>
                        <textarea name="text" class="form-control" rows="5" required><?php echo ($row['text'])?></textarea>
                    </div>
