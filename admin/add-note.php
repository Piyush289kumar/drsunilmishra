...
if (isset($_POST['submit'])) {
    ...
    $sql_insert_post = "INSERT INTO note (note_text,date)
...
<div id="admin-content">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="admin-heading">Update Note</h1>
            </div>
            <div class="col-md-offset-3 col-md-6">
                ...
                $sql_show_post_data = "SELECT * FROM note ORDER BY note_id DESC LIMIT 0,1";
                ...
                <div class="form-group">
                        ...
                        <textarea name="note" class="form-control" rows="5" required><?php echo ($row['note_text'])?></textarea>
                    </div>
